                        ...
                        <div class="flex h-50 bg-zinc-800 rounded-lg border border-gray-700 overflow-hidden hover:border-accent transition">
                            ...
                            <div class="flex flex-col justify-between p-3 flex-1">
                                <div>
                                    ...
                                    {{-- @if($episode->synopsis)
                                        <p class="text-gray-400 text-base mt-1 line-clamp-2 justify-self-start">{{ $episode->synopsis }}</p>
                                    @endif --}}
                                    <p class="text-gray-200 text-base mt-2 justify-self-start">
                                        @if($episode->synopsis) {{ $episode->synopsis }} @else <span class="text-gray-400">Sem sinopse disponível.</span> @endif
                                    </p>
                                </div>
