...
<body class="bg-[#181624] text-white min-h-dvh">
    <nav class="fixed top-0 left-0 right-0 z-50 bg-indigo-50 border-b border-accent shadow-sm">
        <div class="flex items-center justify-between px-6 h-16">
            <a href="{{ route('home') }}">
                <img src="{{ asset('images/re-zero-logo.png') }}" alt="Logo" class="h-14 w-auto object-contain">
            </a>
            ...
            <div class="flex items-center gap-3">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm font-semibold text-accent hover:underline">Login</a>
